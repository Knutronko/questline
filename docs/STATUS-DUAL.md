...
> Última revisión: **2026-09-10** (G1 implications ✅; **next = FP-G4** balance agent + HUD; phase-12 test agents parked after G4).
...
|----------|-------------|----------------|-----------|---------|
| **questline** | v0.1 + **05b–10** + **FP-G1** + **FP-G2** + **FP-G3** + **11** ✅ | G1 implications persist; Groq/Ollama fixture smoke | **FP-G4** balance agent + HUD (Pablo reviews whole UI). Phase-12 test agents **after** G4 | AltTester Desktop fuera del happy path; 09c parked; INC-0010 open; **Mistral live smoke deferred** |
...
| **FP-G4** | Balance agent + HUD | ⬜ **next** | Interactive *model reasoning* retune priorities + GameLens/telemetry HUD. Pablo full-UI review. Brief [`phase-fp-g4`](phases/phase-fp-g4-balance-agent.md) |
| 12 | AI agents | ⬜ **parked after G4** | Kernel + triage / maintainer / healer. **Not** the balance agent. Brief [`phase-12`](phases/phase-12-ai-agents.md) |
| **12b** | HUD GameLens (browse-only) | ⬜ **folded into G4** | Do not start. Browse + agent ship as FP-G4. Historical brief [`phase-12b`](phases/phase-12b-hud-gamelens.md) |
...
|---|---------|------|----------------|
| 1 | **FP-G4** GameLens balance agent + HUD | questline | Retune *priorities* + browse G1/G2/G3 in HUD. **Pablo: full HUD review.** Brief [`phase-fp-g4`](phases/phase-fp-g4-balance-agent.md) |
...
| 2 | **phase-12** AI agents (tool loop) | questline | **After G4.** Triage / diagnose / heal **tests**, not SOs. Brief [`phase-12`](phases/phase-12-ai-agents.md) |
...
**Next:** FP-G4 — [`SESSION-PROMPTS-G4-BALANCE-AGENT.md`](phases/SESSION-PROMPTS-G4-BALANCE-AGENT.md).
Phase-12 after G4. Phase-12b folded into G4.
...
| HUD control center | [`hud.md`](hud.md) · [`ADR-0007`](adr/ADR-0007-hud-frontend-stack.md) · [`phase-10`](phases/phase-10-hud-control-center.md) · GameLens HUD **FP-G4** [`phase-fp-g4`](phases/phase-fp-g4-balance-agent.md) |
...
| FP-G4 balance agent + HUD (**next**) | [`phase-fp-g4`](phases/phase-fp-g4-balance-agent.md) · prompts [`SESSION-PROMPTS-G4-BALANCE-AGENT.md`](phases/SESSION-PROMPTS-G4-BALANCE-AGENT.md) |
...
| AI agents (12, parked after G4) | [`02-AI-ROADMAP.md`](02-AI-ROADMAP.md) · [`phase-12`](phases/phase-12-ai-agents.md) |
