...
> Última revisión: **2026-09-10** (FP-G4 balance agent + HUD ✅; **next = phase-12** test agents parked).
...
|----------|-------------|----------------|-----------|---------|
| **questline** | v0.1 + **05b–11** + **FP-G1** + **FP-G2** + **FP-G3** + **FP-G4** ✅ | G4 GameLens HUD + balance agent | **phase-12** test agents (parked until after G4 merge). Pablo HUD walk in G4 PR | AltTester Desktop fuera del happy path; 09c parked; INC-0010 open; **Mistral live smoke deferred** |
...
| **FP-G4** | Balance agent + HUD | ✅ | Interactive *model reasoning* retune priorities + GameLens/telemetry HUD. Pablo full-UI review. Brief [`phase-fp-g4`](phases/phase-fp-g4-balance-agent.md) |
| 12 | AI agents | ⬜ **next (parked until G4 merges)** | Kernel + triage / maintainer / healer. **Not** the balance agent. Brief [`phase-12`](phases/phase-12-ai-agents.md) |
...
|---|---------|------|----------------|
| 1 | **phase-12** AI agents (tool loop) | questline | **After G4 merge.** Triage / diagnose / heal **tests**, not SOs. Brief [`phase-12`](phases/phase-12-ai-agents.md) |
...
**Next:** phase-12 test agents after this FP merges — [`phase-12-ai-agents.md`](phases/phase-12-ai-agents.md).
Phase-12b folded into G4.
