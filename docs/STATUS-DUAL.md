...
> Última revisión: **2026-09-20** (FP-G4 ✅ PR #36/#37; Unity CLI catalogued **FP-U1/U2** + game **QL-8**; **next = phase-12**).
...
|----------|-------------|----------------|-----------|---------|
| **questline** | v0.1 + **05b–11** + **FP-G1** + **FP-G2** + **FP-G3** + **FP-G4** ✅ | G4 merged (PR #36); HUD walk + live Groq Ask 2026-09-20; **FP-U1/U2** catalogued (Unity CLI sidecar — after 12) | **phase-12** test agents (triage / diagnose / healer). Parallel: D11 feel playtest; optional **QL-8** | AltTester Desktop fuera del happy path; 09c parked; INC-0010 open; **Mistral live smoke deferred** |
...
| 12 | AI agents | ⬜ **next** | Kernel + triage / maintainer / healer. **Not** the GameLens balance agent (that is G4). Brief [`phase-12`](phases/phase-12-ai-agents.md) · prompts [`SESSION-PROMPTS-POST-G4.md`](phases/SESSION-PROMPTS-POST-G4.md) |
...
|---|---------|------|----------------|
| 1 | **phase-12** AI agents (tool loop) | questline | G4 merged. Triage / diagnose / heal **tests**, not SOs. Brief [`phase-12`](phases/phase-12-ai-agents.md) |
...
**Next (questline):** phase-12 test agents — [`phase-12-ai-agents.md`](phases/phase-12-ai-agents.md).
...
| AI agents (12, next) | [`02-AI-ROADMAP.md`](02-AI-ROADMAP.md) · [`phase-12`](phases/phase-12-ai-agents.md) · [`SESSION-PROMPTS-POST-G4.md`](phases/SESSION-PROMPTS-POST-G4.md) |
