...
### 3.4 Test generation (Phase 13) — **shipped (PR #40)**
...
### 3.5 Unit-test generation for the framework itself (Phase 13) — **shipped (PR #40)**
...
### 3.6 Eval harness (Phase 13) — the flagship — **shipped (PR #40)**
...
(generation + eval harness) shipped **PR #40**. Do **not** invert
