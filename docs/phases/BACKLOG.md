...
- [ ] (phase-05 exit) Scaffold game-repo `automation/` + coverage-demo suite — see
      `docs/GAME-INTEGRATION.md` §3. **Gated on first green live smoke via QuestlineWire
      (phase-05b), not AltTester Desktop.** Do not scaffold from questline phase PRs.
- [x] (phase-04) Live Editor / standalone / soft-reload acceptance — **done via game QL-1**
