(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function a(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=a(r);fetch(r.href,i)}})();let _=null;async function b(t){const e=await fetch(t);if(!e.ok){const a=await e.text();throw new Error(`${e.status} ${t}: ${a}`)}return await e.json()}async function S(){return _||(_=(await b("/api/csrf")).csrf_token,_)}async function k(t,e,a){const s=await S(),r=await fetch(e,{method:t,headers:{"Content-Type":"application/json","X-CSRF-Token":s},body:a===void 0?void 0:JSON.stringify(a)});if(!r.ok){const i=await r.text();throw new Error(`${r.status} ${e}: ${i}`)}if(r.status!==204)return await r.json()}function I(){return b("/api/meta")}function N(t){const e=new URLSearchParams;t.profile&&e.set("profile",t.profile),t.status&&e.set("status",t.status);const a=e.toString();return b(`/api/runs${a?`?${a}`:""}`)}function H(t){return b(`/api/runs/${encodeURIComponent(t)}`)}function J(t,e){return b(`/api/runs/${encodeURIComponent(t)}/tests/${encodeURIComponent(e)}`)}function Q(t=50){return b(`/api/trends?limit=${t}`)}function L(t){const e=t?`?config=${encodeURIComponent(t)}`:"";return b(`/api/profiles${e}`)}function W(){return b("/api/configs")}function T(){return b("/api/devices")}function O(t){return b(`/api/profiles/${encodeURIComponent(t)}`)}function K(t,e){return k("POST",`/api/profiles/${encodeURIComponent(t)}/validate`,{fields:e,apply:!1})}function P(t,e,a){return k("POST",`/api/profiles/${encodeURIComponent(t)}`,{fields:e,apply:a})}function V(){return b("/api/reporters")}function j(){return b("/api/launcher")}function G(t){return k("POST","/api/launcher/start",t)}function z(){return k("POST","/api/launcher/stop")}function X(){return b("/api/quarantine")}function Y(t){return k("POST","/api/quarantine",t)}function Z(t){return k("DELETE",`/api/quarantine?test_id=${encodeURIComponent(t)}`)}function tt(t){return k("POST","/api/quarantine/audit",t||{})}function M(t){return b(`/api/perf/${encodeURIComponent(t)}`)}function et(t,e){return b(`/api/perf/compare?a=${encodeURIComponent(t)}&b=${encodeURIComponent(e)}`)}function at(t=50){return b(`/api/perf/correlation?limit=${t}`)}function nt(t){return`/api/artifacts/file?path=${encodeURIComponent(t)}`}function x(t){if(t==null||Number.isNaN(t))return"—";if(t<60)return`${t.toFixed(1)}s`;const e=Math.floor(t/60),a=t-e*60;return`${e}m ${a.toFixed(0)}s`}function n(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}async function st(t){const e=await H(t),a=e.run,s=e.banner,r=e.tests.map(i=>`
  ...
  `}async function it(t,e){const a=await J(t,e),s=a.test,r=a.steps.map(f=>{const v=String(f.status??"");return`<li data-testid="step-row">
  ...
  `}async function rt(){const[t,e]=await Promise.all([Q(50),at(50)]),a=t.series||[],s=Math.max(1,...a.map(o=>Number(o.duration_s??0)||0)),r=a.map(o=>{const l=o.pass_rate==null?0:Number(o.pass_rate),$=Math.max(4,Math.round(l*100)),f=Number(o.duration_s??0);return`<div class="bar ${Number(o.failed??0)>0?"fail":""}" style="height:${$}%">
  ...
  `}function lt(){var $,f,v;const t=document.getElementById("launch-status"),e=document.getElementById("launch-config"),a=document.getElementById("launch-profile"),s=document.getElementById("launch-device"),r=document.getElementById("launch-tests"),i=document.getElementById("launch-live"),d=document.getElementById("launch-device-hint"),c=async()=>{if(!(!e||!a))try{const p=await L(e.value),h=p.profiles.includes("editor")?"editor":p.profiles[0]||"";a.innerHTML=p.profiles.map(m=>`<option value="${n(m)}" ${m===h?"selected":""}>${n(m)}</option>`).join("")}catch(p){t&&(t.textContent=String(p))}},o=async()=>{var p;if(s)try{const h=await T();s.innerHTML=['<option value="">(no adb pin — OK for Editor)</option>',...(h.devices||[]).map(m=>`<option value="${n(m.id)}">${n(m.id)} · ${n(m.platform)}</option>`)].join(""),d&&(d.textContent=h.hint||((p=h.devices)!=null&&p.length?`${h.devices.length} adb device(s)`:"No adb devices — normal for Unity Editor Wire."))}catch(h){d&&(d.textContent=String(h))}};e==null||e.addEventListener("change",()=>{c()}),($=document.getElementById("launch-refresh-devices"))==null||$.addEventListener("click",()=>{o()}),document.querySelectorAll(".preset").forEach(p=>{p.addEventListener("click",()=>{const h=p.dataset.preset||"",m=U.find(y=>y.id===h);if(m){if(e){if(!Array.from(e.options).some(u=>u.value===m.config)){const u=document.createElement("option");u.value=m.config,u.textContent=m.config,e.appendChild(u)}e.value=m.config}r&&(r.value=m.tests),i&&(i.checked=m.live_target),(async()=>(await c(),a&&(a.value=m.profile)))()}})});const l=async()=>{try{const{launcher:p}=await j();t&&(t.textContent=JSON.stringify(p,null,2))}catch(p){t&&(t.textContent=String(p))}};(f=document.getElementById("launch-start"))==null||f.addEventListener("click",()=>{(async()=>{var C;const p=(a==null?void 0:a.value)||"",h=(s==null?void 0:s.value)||"",m=document.getElementById("launch-markers").value.trim(),u=((r==null?void 0:r.value)||"").split(/\r?\n/).map(w=>w.trim()).filter(Boolean),g=Array.from(document.querySelectorAll('input[name="reporter"]:checked')).map(w=>w.value),A=(C=document.getElementById("launch-quarantine"))==null?void 0:C.checked;try{const{launcher:w}=await G({profile:p,tests:u,markers:m||void 0,device_serial:h||void 0,reporters:g.length?g:void 0,include_quarantined:!!A,config:(e==null?void 0:e.value)||void 0,live_target:!!(i!=null&&i.checked)});t&&(t.textContent=JSON.stringify(w,null,2)),location.hash="/live"}catch(w){t&&(t.textContent=String(w))}})()}),(v=document.getElementById("launch-stop"))==null||v.addEventListener("click",()=>{(async()=>{try{const{launcher:p}=await z();t&&(t.textContent=JSON.stringify(p,null,2))}catch(p){t&&(t.textContent=String(p))}})()}),l(),window.setInterval(()=>{location.hash.replace(/^#\/?/,"").startsWith("launch")&&l()},2e3)}async function ut(){if(await S(),(await I()).read_only)return`<h1>Quarantine</h1>
  ...
  `}function ht(){var r,i,d,c;const t=document.getElementById("prof-msg"),e=document.getElementById("prof-fields"),a=document.getElementById("prof-name"),s=()=>e?JSON.parse(e.value):{};(r=document.getElementById("prof-load"))==null||r.addEventListener("click",()=>{(async()=>{try{const o=(a==null?void 0:a.value)||"",l=await O(o);e&&(e.value=JSON.stringify(l.fields,null,2)),t&&(t.textContent=`loaded ${o}`)}catch(o){t&&(t.textContent=String(o))}})()}),(i=document.getElementById("prof-validate"))==null||i.addEventListener("click",()=>{(async()=>{try{const o=(a==null?void 0:a.value)||"",l=await K(o,s());t&&(t.textContent=l.ok?`OK
...
`))}catch(o){t&&(t.textContent=String(o))}})()})}function q(t,e="var(--accent)"){const a=t.map(l=>Number(l.v??0));if(!a.length)return'<span class="meta">no samples</span>';const s=Math.min(...a),r=Math.max(...a),i=Math.max(1e-9,r-s),d=320,c=64,o=a.map((l,$)=>{const f=$/Math.max(1,a.length-1)*d,v=c-(l-s)/i*(c-4)-2;return`${f.toFixed(1)},${v.toFixed(1)}`}).join(" ");return`<svg class="spark" viewBox="0 0 ${d} ${c}" width="${d}" height="${c}">
    <polyline fill="none" stroke="${e}" stroke-width="1.5" points="${o}"/>
  </svg>`}async function mt(){var r;const t=await N({}),e=t.runs.map(i=>`<option value="${n(i.id)}">${n(i.id.slice(0,8))}… · ${n(i.profile)}</option>`).join(""),a=((r=t.runs[0])==null?void 0:r.id)||"";let s='<div class="empty">Pick a run to load perf series.</div>';if(a){const i=await M(a);s=D(a,i.series,i.summary)}return`
    <h1>Perf graphs</h1>
    ...
    <\/script>
  `}function D(t,e,a){const s=Object.keys(e);return s.length?s.map(r=>{var d,c;const i=a[r]||{};return`<div class="panel" data-testid="perf-metric">
        <h2>${n(r)} <span class="meta">avg ${n(((c=(d=i.avg)==null?void 0:d.toFixed)==null?void 0:c.call(d,2))??"—")} · n ${n(i.count??0)}</span></h2>
        ${q(e[r]||[])}
      </div>`}).join(""):`<div class="empty">No perf samples for ${n(t)}.</div>`}function vt(){var i,d;const t=document.getElementById("perf-series"),e=document.getElementById("perf-compare-out"),a=document.getElementById("perf-run"),s=document.getElementById("perf-a"),r=document.getElementById("perf-b");s&&r&&r.options.length>1&&(r.selectedIndex=1),(i=document.getElementById("perf-load"))==null||i.addEventListener("click",()=>{(async()=>{const c=(a==null?void 0:a.value)||"";if(!(!c||!t))try{const o=await M(c);t.innerHTML=D(c,o.series,o.summary)}catch(o){t.textContent=String(o)}})()}),(d=document.getElementById("perf-compare"))==null||d.addEventListener("click",()=>{(async()=>{const c=(s==null?void 0:s.value)||"",o=(r==null?void 0:r.value)||"";if(e)try{const l=await et(c,o),$=l.deltas.map(v=>{var p,h,m,y,u,g;return`<tr>
              <td>${n(v.metric)}</td>
              ...
              <h2>${n(v)} overlay</h2>
              <div class="toolbar">
                <span class="meta">A</span>${q(p,"var(--accent)")}
                <span class="meta">B</span>${q(h,"var(--ok)")}
              </div>
          ...
          ${f}`}catch(l){e.textContent=String(l)}})()})}const B=document.querySelector("#app");let E=!1;function R(t,e){const a=(r,i)=>`<a href="${r}" class="${t===i?"active":""}">${i}</a>`,s=E?"":`${a("#/launch","Launch")}
    ...
    <header class="topbar">
      ...
      ${E?'<span class="badge warn" title="--read-only">RO</span>':""}
    </header>
  ...
  `}function $t(){const e=(location.hash.replace(/^#\/?/,"")||"").split("/").filter(Boolean);return e[0]==="runs"&&e[1]&&e[2]==="tests"&&e[3]?{name:"test",params:{runId:e[1],testId:e[3]}}:e[0]==="runs"&&e[1]?{name:"run",params:{runId:e[1]}}:e[0]==="trends"?{name:"trends",params:{}}:e[0]==="live"?{name:"live",params:{}}:e[0]==="launch"?{name:"launch",params:{}}:e[0]==="quarantine"?{name:"quarantine",params:{}}:e[0]==="profiles"?{name:"profiles",params:{}}:e[0]==="perf"?{name:"perf",params:{}}:{name:"runs",params:{}}}function bt(t){return t.length?`
    ...
    <div class="toolbar">
      ...
      ${E?"":'<a class="btn" href="#/launch">Launch run</a>'}
    </div>
    ${bt(s.runs)}
  `}async function F(){const t=$t();try{let e="",a="Runs";t.name==="run"?(e=await st(t.params.runId),a="Runs"):t.name==="test"?(e=await it(t.params.runId,t.params.testId),a="Runs"):t.name==="trends"?(e=await rt(),a="Trends"):t.name==="live"?(e=await ot(),a="Live"):t.name==="launch"?(e=await ct(),a="Launch"):t.name==="quarantine"?(e=await ut(),a="Quarantine"):t.name==="profiles"?(e=await ft(),a="Profiles"):t.name==="perf"?(e=await mt(),a="Perf"):(e=await yt(),a="Runs"),B.innerHTML=R(a,e),gt(t.name)}catch(e){B.innerHTML=R("Runs",`<div class="empty">Failed to load HUD: ${n(String(e))}</div>`)}}function gt(t){var e;if(t==="runs"&&((e=document.getElementById("f-apply"))==null||e.addEventListener("click",()=>{const a=document.getElementById("f-profile").value.trim(),s=document.getElementById("f-status").value,r=new URLSearchParams;a&&r.set("profile",a),s&&r.set("status",s);const i=r.toString();location.hash=i?`/?${i}`:"/"})),t==="live"){const a=document.getElementById("live-root");a&&dt(a)}t==="launch"&&lt(),t==="quarantine"&&pt(),t==="profiles"&&ht(),t==="perf"&&vt()}async function wt(){try{E=!!(await I()).read_only,E||await S()}catch{E=!1}await F()}window.addEventListener("hashchange",()=>{F()});wt();
